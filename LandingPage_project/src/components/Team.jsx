              ...
              <div className="col-lg-6" data-aos="zoom-in" data-aos-delay={100}>
                <div className="member d-flex align-items-start">
                  ...
                  <div className="member-info">
                    ...
                    <span>Developer</span>
                    <p>
                      I appreciate the company's commitment to diversity and
                      inclusion, creating a welcoming environment for all
                      employees.
                    </p>
                ...
                <div className="member d-flex align-items-start">
                  ...
                  <div className="member-info">
                    ...
                    <p>
                      ...
                      within the company are unmatched in the industry.
                    </p>
                    <div className="social">
                      <a href="">
                        <i className="ri-twitter-fill" />
              ...
              <div
                ...
                <div className="member d-flex align-items-start">
                  ...
                  <div className="member-info">
                    ...
                    <span>Developer</span>
                    <p>
                      I am proud to work for a company that prioritizes ethical
                      business practices and corporate responsibility.
                    </p>
                    <div className="social">
                      <a href="">
                        <i className="ri-twitter-fill" />
              ...
              <div
                ...
                <div className="member d-flex align-items-start">
                  ...
                  <div className="member-info">
                    ...
                    <span>Developer</span>
                    <p>
                      The team-oriented culture fosters collaboration and
                      communication, enabling us to achieve outstanding results
                      for our clients.
                    </p>
                    <div className="social">
                      <a href="">
